...
type mockConstructorTestingTNewSaramaConsumerGroupClaim interface {
	mock.TestingT
	Cleanup(func())
}

// NewSaramaConsumerGroupClaim creates a new instance of SaramaConsumerGroupClaim. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewSaramaConsumerGroupClaim(t mockConstructorTestingTNewSaramaConsumerGroupClaim) *SaramaConsumerGroupClaim {
	mock := &SaramaConsumerGroupClaim{}
	mock.Mock.Test(t)
