...
type mockConstructorTestingTNewSaramaConsumerGroupSession interface {
	mock.TestingT
	Cleanup(func())
}

// NewSaramaConsumerGroupSession creates a new instance of SaramaConsumerGroupSession. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewSaramaConsumerGroupSession(t mockConstructorTestingTNewSaramaConsumerGroupSession) *SaramaConsumerGroupSession {
	mock := &SaramaConsumerGroupSession{}
	mock.Mock.Test(t)
